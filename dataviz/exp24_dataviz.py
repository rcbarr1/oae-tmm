...
from dataviz.dataviz import plot_surface2d, plot_longitude3d
import xarray as xr
import numpy as np
...
# for t_idx in tqdm(range(0, 2)):
    plot_surface2d(model_lon, model_lat, ds.delDIC.isel(time=t_idx, depth=0)+0.0001, 0, 0.1, 'viridis', 'delDIC at t = ' + str(ds.time.isel(time=t_idx).values))

...
| pyTRACE CO₂ scenarios | installed as a package (see below) | Carter et al. (2025), *ESSD* — https://doi.org/10.5194/essd-17-3073-2025 |
...
data/
  ...
  GLODAPv2.2016b.MappedProduct/     ← raw files here; regridded .nc files written here
  NCEP_DOE_Reanalysis_II/
    icec.nc
    wspd.nc
  NOAA_Extended_Reconstruction_SST_V5/
    sst.nc
  TRACE_gridded/                    ← generated by make_trace_gridded.py
```
